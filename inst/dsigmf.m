...
## the corresponding @var{y} values for the difference between two sigmoidal
...
##
## @noindent
## To run this code, type @t{dsigmf_demo} at the Octave prompt.
##
## @seealso{dsigmf_demo, gauss2mf, gaussmf, gbellmf, pimf, psigmf, sigmf, smf, trapmf, trimf, zmf}
## @end deftypefn
