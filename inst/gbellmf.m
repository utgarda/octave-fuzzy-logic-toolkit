...
##
## For a given domain (@var{x} or @var{[x1 x2 ... xn]}) and parameters
## (@var{params} or @var{[a b c]}), return the corresponding @var{y}
## values for the generalized bell-shaped membership function.
##
...
##
## @noindent
## To run this code, type @t{gbellmf_demo} at the Octave prompt.
##
## @seealso{dsigmf, gauss2mf, gaussmf, gbellmf_demo, pimf, psigmf, sigmf, smf, trapmf, trimf, zmf}
## @end deftypefn
