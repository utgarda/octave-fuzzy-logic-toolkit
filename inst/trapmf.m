...
## parameters (@var{params} or @var{[a b c d]}), return the
## corresponding @var{y} values for the trapezoidal membership function. The
## argument @var{x} must be a real number or a non-empty vector of strictly
## increasing real numbers, and parameters @var{a}, @var{b}, @var{c}, and
## @var{d} must satisfy the inequalities:
...
##
## @noindent
## To run this code, type @t{trapmf_demo} at the Octave prompt.
##
## @seealso{dsigmf, gauss2mf, gaussmf, gbellmf, pimf, psigmf, sigmf, smf, trapmf_demo, trimf, zmf}
## @end deftypefn
