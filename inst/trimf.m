...
## parameters (@var{params} or @var{[a b c]}), return the
## corresponding @var{y} values for the triangular membership function.
##
...
##
## @noindent
## To run this code, type @t{trimf_demo} at the Octave prompt.
##
