...
## parameters (@var{params} or @var{[a c]}), return the corresponding
## @var{y} values for the sigmoidal membership function.
##
...
##
## @noindent
## To run this code, type @t{sigmf_demo} at the Octave prompt.
##
## @seealso{dsigmf, gauss2mf, gaussmf, gbellmf, pimf, psigmf, sigmf_demo, smf, trapmf, trimf, zmf}
## @end deftypefn
