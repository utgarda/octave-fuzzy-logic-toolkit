...
## parameters (@var{params} or @var{[a b c d]}),
## return the corresponding @var{y} values for the pi-shaped
## membership function.
##
...
##
## @noindent
## To run this code, type @t{pimf_demo} at the Octave prompt.
##
## @seealso{dsigmf, gauss2mf, gaussmf, gbellmf, pimf_demo, psigmf, sigmf, smf, trapmf, trimf, zmf}
## @end deftypefn
