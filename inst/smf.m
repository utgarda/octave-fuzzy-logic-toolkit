...
## parameters (@var{params} or @var{[a b]}), return the corresponding
## @var{y} values for the S-shaped membership function.
##
...
##
## @noindent
## To run this code, type @t{smf_demo} at the Octave prompt.
##
## @seealso{dsigmf, gauss2mf, gaussmf, gbellmf, pimf, psigmf, sigmf, smf_demo, trapmf, trimf, zmf}
## @end deftypefn
