...
## parameters (@var{params} or @var{[sig c]}), return the corresponding
## @var{y} values for the Gaussian membership function, a curve shaped like the
## Gaussian (normal) distribution, but scaled to have a maximum value of 1. By
...
## increasing real numbers, and @var{sig} and @var{c} must be real numbers. This
...
##
## @noindent
## To run this code, type @t{gaussmf_demo} at the Octave prompt.
##
## @seealso{dsigmf, gauss2mf, gaussmf_demo, gbellmf, pimf, psigmf, sigmf, smf, trapmf, trimf, zmf}
## @end deftypefn
