...
## parameters (@var{params} or @var{[a1 c1 a2 c2]}), return
## the corresponding @var{y} values for the product of two sigmoidal membership
## functions.
##
...
##
## @noindent
## To run this code, type @t{psigmf_demo} at the Octave prompt.
##
## @seealso{dsigmf, gauss2mf, gaussmf, gbellmf, pimf, psigmf_demo, sigmf, smf, trapmf, trimf, zmf}
## @end deftypefn
