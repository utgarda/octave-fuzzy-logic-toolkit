...
## parameters (@var{params} or @var{[sig1 c1 sig2 c2]}),
## return the corresponding @var{y} values for the two-sided Gaussian composite
## membership function, a smooth curve calculated from two Gaussian membership
...
##
## @noindent
## To run this code, type @t{gauss2mf_demo} at the Octave prompt.
##
## @seealso{dsigmf, gauss2mf_demo, gaussmf, gbellmf, pimf, psigmf, sigmf, smf, trapmf, trimf, zmf}
## @end deftypefn
