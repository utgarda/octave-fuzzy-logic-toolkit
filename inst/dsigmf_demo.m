...
## -*- texinfo -*-
## @deftypefn {Script File} {} dsigmf_demo
##
## Demonstrate the function @t{dsigmf} by executing the code
## given in the comment at the top of dsigmf.m.
##
## @seealso{dsigmf}
## @end deftypefn
